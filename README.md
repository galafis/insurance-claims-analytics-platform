...
**Insurance Claims Analytics Platform** — Insurance Claims Analytics Platform with fraud detection and ML - Advanced analytics for insurance companies

Total source lines: **115** across **2** files in **1** language.
...
# Run the container
docker run -p 8000:8000 insurance-claims-analytics-platform
```
...
Total de linhas de código: **115** em **2** arquivos em **1** linguagem.
